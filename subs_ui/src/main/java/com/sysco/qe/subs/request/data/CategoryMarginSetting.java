...
public class CategoryMarginSetting extends RequestBase {
     ...
     * @param categoryId
     */
    public CategoryMarginSetting(List<String> opcos, String categoryId, String categoryType, String modificationType, String margin,String priceZone) {
        super();
        this.opcos = opcos;
